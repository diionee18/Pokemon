const lagSpelare = () =>{
  ...
  if(pokeCounter < 3){
    antalSpelare.innerHTML = `<span class="lagets-spelare"> Du har ${pokeCounter} Pokémon <br>  </span>För att kunna spela behöver du minst ${3- pokeCounter} till`
    antalSpelare.style.border = "solid red 5px";
    antalSpelare.style.padding = "0em 2em"
  }else{
    antalSpelare.innerHTML = `<span class="lagets-spelare"> Du har ${pokeCounter} ordinare Pokémon <br>  </span> och du har <span class="lagets-spelare" > ${antalReserv} </span> i reserv, du kan lägga till fler `
